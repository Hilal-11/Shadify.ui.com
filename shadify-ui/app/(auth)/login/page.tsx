...
const  Login = () => {
  ...
  const formSubmitHandler = (event: FormEvent<HTMLFormElement>) => {
    ...
    const parse = signupSchema.safeParse(loginFormData);
    if(!parse.success) {
      ...
      shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] px-4 py-4">
        ...
        <form onSubmit={formSubmitHandler} className="">
            ...
            <div className="mt-3">
                ...
                <Input onChange={onChangeFormHandler} value={loginFormData.username} className="py-5" id="username" name="username" type="text" placeholder="Enter username:- "/>
            ...
            <div className="mt-3">
                ...
                <Input onChange={onChangeFormHandler} value={loginFormData.email} className="py-5" id="email" name="email" type="email" placeholder="Enter email ID:- "/>
            ...
            <div className="mt-3">
                ...
                <Input onChange={onChangeFormHandler} value={loginFormData.password} className="py-5" id="password" name="password" type="password" placeholder="Enter Password:-"/>
