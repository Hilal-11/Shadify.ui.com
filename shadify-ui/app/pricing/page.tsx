    ...
    <div className='bg-[#f4f4f5] dark:bg-neutral-950 h-full'>
      ...
      <div className='pt-24 w-full h-auto container py-20'>
        <div className="flex flex-col items-center gap-6 pb-10 py-20">
          ...
          <div className="flex items-center items-center px-10 lg:px-28">
            <h1 className="lg:text-6xl md:text-5xl text-4xl font-sans font-bold text-center space-y-4">Simply choose the pricing plan that <br /> <span className="ml-4 px-2 text-orange-500 bg-neutral-200 dark:bg-neutral-900 rounded-lg shadow-[inset_-12px_-8px_40px_#46464620]"> fits you best.</span></h1>
          </div>
        </div>
