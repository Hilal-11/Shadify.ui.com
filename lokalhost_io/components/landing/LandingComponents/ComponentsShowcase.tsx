        ...
        <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 justify-evenly lg:px-10 px-5 py-10 gap-6'>
           {
            ...
            <div key={index} className='lg:w-[250px] w-full lg:h-[250px] h-[250px] rounded-sm shadow-sm bg-white dark:bg-neutral-900 border flex justify-center items-center'>
                <div className='w-full h-full flex flex-col justify-between'>
                    <div></div>
                    <div className='w-full h-[60px] bg-neutral-100 border-t'></div>
                </div>
            </div>
            ))
           }
