...
function TemplatesShowcase() {
  return (
    ...
    servicesShowCaseConfig[1].templates_list_1?.map((template) => (
      <div className='snap-center shrink-0 w-[180px] lg:w-[250px] bg-neutral-50 dark:bg-neutral-900 h-[120px] lg:h-[250px] rounded-sm shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]'>
