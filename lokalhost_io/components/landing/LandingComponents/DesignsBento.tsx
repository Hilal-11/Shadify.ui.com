  ...
  return (
    <div className='w-full h-full'>
        ...
        <div className="pt-10 relative h-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-0 lg:gap-0 border-b border-dashed px-px">
            ...
            <div className="relative overflow-hidden h-[340px] w-full border-r border-dashed border-t px-3 py-3">
                <motion.div
                      className="flex w-full h-full items-start justify-center">
                      <img className="z-20 rounded-sm object-cover w-[380px] absolute -left-4 -top-4 border-3" alt="templates" src="https://cdn.dribbble.com/userupload/16994810/file/original-c6a72b1649c9ba7b49f8b363761c669f.jpg?resize=1200x900&vertical=center" />
                      <img className="border-2 z-20 rounded-sm object-cover w-[380px] absolute -bottom-0 -right-3" alt="templates" src="https://cdn.shadcnstudio.com/ss-assets/landing-page/figma-column-2-light.png?width=390&format=auto" />
                </motion.div>
            </div>
            
            <div className="relative overflow-hidden h-[340px] w-full border-r border-dashed border-t mask-r-from-80% to-100% px-3 py-3">
                    <motion.div
                      className="flex w-full h-full items-start justify-center">
                      <img className="z-20 rounded-sm object-cover w-[380px] absolute -left-4 -top-4 border-3" alt="templates" src="https://cdn.dribbble.com/userupload/44078184/file/original-c54c15a616d979fec3ca81e6adf22c07.jpg?resize=1200x899&vertical=center" />
                      <img className="border-2 z-20 rounded-sm object-cover w-[380px] absolute -bottom-3 -right-3" alt="templates" src="https://cdn.dribbble.com/userupload/46050340/file/b6c35f7a9f9154c5f1dc9fddd490997d.jpg?resize=1200x900&vertical=center" />
                    </motion.div>
            </div>
        </div> 
