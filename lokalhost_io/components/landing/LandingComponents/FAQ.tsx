    ...
    return (
        <div className='w-full h-full pt-8 lg:pt-20'>
            <div className='w-full mx-auto py-20 pb-5 flex flex-col items-center justify-center'>
                <h1 className='text-center font-sans font-bold text-2xl lg:text-6xl text-neutral-800 dark:text-neutral-200 pb-2'>Frequently Asked Questions about Lokalhost.io</h1>
