  ...
  return (
    <div className='w-full h-full'>
        <div className='w-full mx-auto pt-8 pb-8 lg:pt-20 relative lg:pb-20 px-2'>
            ...
            className='z-20  text-center font-sans font-bold text-2xl lg:text-4xl text-neutral-800 dark:text-neutral-200 pb-3'>All Essential Features in one place</motion.h1>
            <motion.p
            initial={{ opacity: 0, y: 100 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, }}
            className='px-8 lg:px-2 z-20 text-center text-sm lg:text-[17px] font-sans font-medium text-neutral-700 dark:text-neutral-300 lg:w-1/2 mx-auto'>Features the lokalhost.io provides.</motion.p>
        </div>
